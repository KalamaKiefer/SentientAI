            ...
            <div className="px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:text-center">
                    ...
                    <p className="mt-6 text-lg leading-8 text-gray-300">
                        Embrace a new frontier of creativity and innovation. Our
                        AI-powered platform offers dynamic chatbot interactions,
                        stunning image, video generation, and inspiring music
